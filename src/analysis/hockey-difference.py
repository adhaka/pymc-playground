...
#  this file correctly predicts a change which took place in field hockey rules.
#  the duration of the match was changed from 70 mins to 60 mins to make it more competitive
#  and two halves were replaced by 4 quarters. As a result, the competitiveness of the matches
# increased as is evidenced by the data. We take the difference between the goals scored by the
#  teams in the matches as the feature to implement change point model. The predicition is quite 
#  good, as the change was brought in 2014 before 2014 champions trophy so around 80-90th match, and
#  the model has the highest number of samples in the posteriror distribution at around a value of 80 or 90.
